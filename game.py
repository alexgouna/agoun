...
class MillionaireGame(tk.Toplevel):
    ...
    def stop_game(self):
        self.stop_game_button = tk.Button(self.left_top_frame, text="Stop game",fg="white",font=("Arial",30), bg="black", bd=1,command=lambda:self.game_over(self.counter))
    ...
    def game_over(self,my_counter):
        ...
        if self.total_safe_time!=0:
            ...
            rank.new_rank(prizes[my_counter],round(self.total_safe_time/100),round(self.total_safe_time/my_counter)/100, my_score)
        else:
